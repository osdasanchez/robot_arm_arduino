...
import mx.edu.uicui.jarduino.comm.Udp4JArduino;
...
public abstract class AbstractJArduino {
	...
	public AbstractJArduino(String ID, JArduinoCom com, ProtocolConfiguration conf, Serial4JArduino serial4JArduino) {
        try {
